...
#ifndef RANGE_DATA_MATCHING_TRANSFORM_TRANSFORM_H_
#define RANGE_DATA_MATCHING_TRANSFORM_TRANSFORM_H_
...
#include "transform/transform.pb.h"
...
protos::transform::proto::Rigid2d ToProto(const Rigid2d& transform);
protos::transform::proto::Rigid2f ToProto(const Rigid2f& transform);
protos::transform::proto::Rigid3d ToProto(const Rigid3d& rigid);
Rigid3d ToRigid3(const protos::transform::proto::Rigid3d& rigid);
protos::transform::proto::Rigid3f ToProto(const Rigid3f& rigid);
...
#endif  // RANGE_DATA_MATCHING_TRANSFORM_TRANSFORM_H_
