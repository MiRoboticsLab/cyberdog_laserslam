...
#ifndef RANGE_DATA_MATCHING_TRANSFORM_RIGID_TRANSFORM_H_
#define RANGE_DATA_MATCHING_TRANSFORM_RIGID_TRANSFORM_H_
...
static inline TimedRigid3d Interpolate(const TimedRigid3d& start,
                                       const TimedRigid3d& end,
...
#endif  // RANGE_DATA_MATCHING_TRANSFORM_RIGID_TRANSFORM_H_
