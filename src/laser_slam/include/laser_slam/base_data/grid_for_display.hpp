...
#ifndef LASER_SLAM__BASE_DATA__GRID_FOR_DISPLAY_HPP_
#define LASER_SLAM__BASE_DATA__GRID_FOR_DISPLAY_HPP_
#include <chrono>
#include <thread>
#include <mutex>
#include <queue>
...
#endif  // LASER_SLAM__BASE_DATA__GRID_FOR_DISPLAY_HPP_
