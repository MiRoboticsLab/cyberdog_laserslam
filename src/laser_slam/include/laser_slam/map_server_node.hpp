...
#ifndef LASER_SLAM__MAP_SERVER_NODE_H_
#define LASER_SLAM__MAP_SERVER_NODE_H_
...
class MapServerNode {
  public:
    ...
    void AddRangeDataAndPose(const sensor::RangeData &pc,
...
#endif // LASER_SLAM__MAP_SERVER_NODE_H_
