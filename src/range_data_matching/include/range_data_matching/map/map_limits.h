...
#ifndef RANGE_DATA_MATCHING_MAP_MAP_LIMITS_H_
#define RANGE_DATA_MATCHING_MAP_MAP_LIMITS_H_
...
#include "mapping/map_limits.pb.h"
...
class MapLimits {
 public:
  ...
  explicit MapLimits(const protos::mapping::proto::MapLimits& map_limits)
...
inline protos::mapping::proto::MapLimits ToProto(const MapLimits& map_limits) {
  protos::mapping::proto::MapLimits result;
...
#endif  // RANGE_DATA_MATCHING_MAP_MAP_LIMITS_H_
