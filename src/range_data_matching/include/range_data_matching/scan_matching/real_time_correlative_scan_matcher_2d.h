...
#ifndef RANGE_DATA_MATCHING_MAP_REAL_TIME_CORRELATIVE_SCAN_MATCHER_2D_H_
#define RANGE_DATA_MATCHING_MAP_REAL_TIME_CORRELATIVE_SCAN_MATCHER_2D_H_
...
class RealTimeCorrelativeScanMatcher2D {
 public:
  explicit RealTimeCorrelativeScanMatcher2D(
      const RealTimeCorrelativeScanMatcherParam& param);
 ...
 private:
  ...
  const RealTimeCorrelativeScanMatcherParam param_;
};
...
#endif  // RANGE_DATA_MATCHING_MAP_REAL_TIME_CORRELATIVE_SCAN_MATCHER_2D_H_
