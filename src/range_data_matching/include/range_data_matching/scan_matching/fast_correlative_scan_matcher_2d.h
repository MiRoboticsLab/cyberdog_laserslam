...
#ifndef RANGE_DATA_MATCHING_SCAN_MATCHING_FAST_CORRELATIVE_SCAN_MATCHER_2D_H_
#define RANGE_DATA_MATCHING_SCAN_MATCHING_FAST_CORRELATIVE_SCAN_MATCHER_2D_H_
...
#include "range_data_matching/scan_matching/correlative_scan_matcher_2d.h"
...
class PrecomputationGridStack2D {
 public:
  PrecomputationGridStack2D(const Grid2D& grid,
                            const FastCorrelativeScanMatcherParam& param);
...
class FastCorrelativeScanMatcher2D {
 public:
  ...
  FastCorrelativeScanMatcher2D& operator=(const
  FastCorrelativeScanMatcher2D&) =
      delete;
 ...
 private:
  ...
  const FastCorrelativeScanMatcherParam param_;
  MapLimits limits_;
...
#endif  // RANGE_DATA_MATCHING_SCAN_MATCHING_FAST_CORRELATIVE_SCAN_MATCHER_2D_H_
