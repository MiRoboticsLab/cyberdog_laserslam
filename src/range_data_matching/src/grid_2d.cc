...
float MinCorrespondenceCostFromProto(
    const protos::mapping::proto::Grid2D& proto) {
...
Grid2D::Grid2D(const protos::mapping::proto::Grid2D& proto,
               ValueConversionTables* conversion_tables)
...
protos::mapping::proto::Grid2D Grid2D::ToProto() const {
  protos::mapping::proto::Grid2D result;
