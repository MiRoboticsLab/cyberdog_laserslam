 ...
 *
 */
#ifndef IMU_INTEGRATION_INTEGRATION_HELPER_MATH_UTIL_H_
#define IMU_INTEGRATION_INTEGRATION_HELPER_MATH_UTIL_H_
...
#endif  // IMU_INTEGRATION_INTEGRATION_HELPER_MATH_UTIL_H_